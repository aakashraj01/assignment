const AnswerOptions = ({ options, selectedOption, onSelect, onChallenge }) => {
  ...
  const getOptionClass = (option) => {
    ...
    const base = 'p-4 rounded-lg text-left transition-colors flex items-center border hover:border-blue-200';
    
    if (selectedOption === null) {
      // Default: White background, light border
      return `${base} bg-white border-gray-200 hover:bg-blue-50`;
    } else if (selectedOption === option) {
      // Selected: Blue background, white text
      return `${base} bg-blue-100 border-blue-300 ring-2 ring-blue-300`;
    } else {
  ...
  return (
    <div className="mt-6">
      <h3 className="text-lg font-semibold text-blue-600 mb-4">Select the correct destination</h3>
