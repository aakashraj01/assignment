...
const GameView = () => {
  ...
  const renderLoading = () => (
    <div className="text-center p-10">
      <svg className="animate-spin h-10 w-10 mx-auto text-blue-500 mb-4" xmlns="http://www.w3.org/2000/svg"
  ...
  const renderError = () => (
    <div className="text-center p-10 bg-red-50 rounded-lg border border-red-200">
      ...
      <button onClick={loadNewDestination} className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-md">
        Try Again
      </button>
    </div>
  );
